...
public class CloudController : MonoBehaviour
{
    ...
    {
        float x = random ? Random.Range(spawnAreaMin.x, spawnAreaMax.x) : spawnAreaMin.x;
    ...
    {
        return position.x >= spawnAreaMin.x && position.x <= spawnAreaMax.x &&
               position.z >= spawnAreaMin.y && position.z <= spawnAreaMax.y;
    }
